...
namespace WEBAPI.EF_MODEL
{
    ...
    {
        private static CarDbContext _context;
        ...
        public static IEnumerable<CarBrand> GetCarBrands()
        {
            return _context.CarBrands.ToList();
        }

        public static CarBrand GetCarBrand(Guid guid)
        {
            return _context.CarBrands.SingleOrDefault(cb => cb.Id == guid);
        }

        public static IActionResult CreateCarBrand(NewCarBrand newCarBrand)
        {
        ...
        public static IActionResult UpdateCarBrand(Guid guid, NewCarBrand newCarBrand)
        {
            var carBand = _context.CarBrands.SingleOrDefault(cb => cb.Id == guid);
        ...
        public static IActionResult DeleteCarBrand(Guid guid)
        {
            var carBand = _context.CarBrands.SingleOrDefault(cb => cb.Id == guid);
